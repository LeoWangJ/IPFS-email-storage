  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      ...
      <nav class="hidden md:flex space-x-10">
        <router-link to="" class="text-base font-medium text-gray-500 hover:text-gray-900">Pricing</router-link>
        <router-link to="" class="text-base font-medium text-gray-500 hover:text-gray-900">Docs</router-link>
      </nav>
